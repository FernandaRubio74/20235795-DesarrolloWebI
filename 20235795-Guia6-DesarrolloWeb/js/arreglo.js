...
function agregarElemento() {
    ...
    if (isNaN(numero)) {
        ...
        caja.appendChild(valor); //Le pasamos como hijo la etiqueta <h3></h3> a nuestro <div>

        //Insertamos los nuevos elementos en el contenedor se utiliza beforeend para insertar el nuevo elemento dentro del idContainerArreglo y despues de su ultimo hijo
